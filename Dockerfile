FROM docker.io/library/golang:1.24.0-alpine@sha256:2d40d4fc278dad38be0777d5e2a88a2c6dee51b0b29c97a764fc6c6a11ca893c AS golang
...
ENV KUBERNETES_VERSION=v1.32.2
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:39.185.9-full@sha256:d8958a4f8ca7a4572fe450aca18c12e035c33b605e5ed998a0d3b31bef8c18ae
