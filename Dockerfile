FROM docker.io/library/golang:1.27.1-alpine@sha256:cf6fca6641884b8433441b2b0652976f975e1d0fdd26d177eaaf8596087f3125 AS golang
...
ENV KUBERNETES_VERSION=v1.37.0
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:44.69.11-full@sha256:a9782a4978663a9092cdc9b1ec9fe59810d14a044bb3d2533ce8b01942b268e7
