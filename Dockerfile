FROM docker.io/library/golang:1.26.0-alpine@sha256:d4c4845f5d60c6a974c6000ce58ae079328d03ab7f721a0734277e69905473e5 AS golang
...
ENV KUBERNETES_VERSION=v1.35.1
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:43.31.10-full@sha256:b35d858ca79e959a91d9d61d20c7ec66177c54aa1a7e888ec2049b30336a21b5
