FROM docker.io/library/golang:1.23.5-alpine@sha256:47d337594bd9e667d35514b241569f95fb6d95727c24b19468813d596d5ae596 AS golang
...
ENV KUBERNETES_VERSION=v1.32.1
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:39.120.4-full@sha256:01fa619c713a87a9a8838178022f03b4cdfad022d8f51894a64287b9e52f5f37
