FROM docker.io/library/golang:1.25.5-alpine@sha256:26111811bc967321e7b6f852e914d14bede324cd1accb7f81811929a6a57fea9 AS golang
...
ENV KUBERNETES_VERSION=v1.34.3
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:42.52.3-full@sha256:1528ca4645f6130488acd5f286e3fc476dd089213462d7bf1bb4cba73150890a
