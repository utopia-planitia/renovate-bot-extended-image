FROM docker.io/library/golang:1.27.1-alpine@sha256:8a5910f31396cd4d89662f56c68b3ae31d374308270a1c3bd96672ee5ed43414 AS golang
...
ENV KUBERNETES_VERSION=v1.37.1
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:44.111.4-full@sha256:db31f96d9e322cfe7dfeb0d3729614c7b0ae19a674e0dc4fe194190cd30292dd
