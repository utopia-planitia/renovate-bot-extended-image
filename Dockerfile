FROM docker.io/library/golang:1.25.5-alpine@sha256:ac09a5f469f307e5da71e766b0bd59c9c49ea460a528cc3e6686513d64a6f1fb AS golang
...
ENV KUBERNETES_VERSION=v1.35.0
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:42.81.13-full@sha256:2f6a44f2b6c380e6a53bddbd7d34df4435df5cc16ba10cc470cd46408955c1aa
