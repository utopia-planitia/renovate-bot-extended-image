FROM docker.io/library/golang:1.26.3-alpine@sha256:91eda9776261207ea25fd06b5b7fed8d397dd2c0a283e77f2ab6e91bfa71079d AS golang
...
ENV KUBERNETES_VERSION=v1.36.0
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:43.170.18-full@sha256:b377453bf73f3285a0d2e3dcad750cf18abe27362ea7130453c0f64aa6752062
