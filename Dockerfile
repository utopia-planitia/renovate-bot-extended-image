FROM docker.io/library/golang:1.26.2-alpine@sha256:27f829349da645e287cb195a9921c106fc224eeebbdc33aeb0f4fca2382befa6 AS golang
...
ENV KUBERNETES_VERSION=v1.35.4
RUN set -eux; \
...
# renovate
FROM docker.io/renovate/renovate:43.113.0-full@sha256:19d9dbac63e9dca13681cee9d1639c50828fcb30b63aa995c303755d228b4a0d
